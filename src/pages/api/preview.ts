...
const createClientOptions = (req = null, prismicAccessToken = null): ApiOptions => {
...
const Client = (req = null): DefaultClient =>
    Prismic.client(process.env.PRISMIC_API_ENDPOINT, createClientOptions(req, accessToken));
